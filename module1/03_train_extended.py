...
def main():
    ...
    print("MODE: EXTENDED (3 models × 4 configs × 2 SMOTE variants × 2 feature sets = 48 runs)")
    print("=" * 80)
    ...
    print("\n💬 Script Selection:")
    print("  Quick version (8 runs):   python 03_train_quick.py")
    print("  Extended version (48 runs): python 03_train_extended.py")
